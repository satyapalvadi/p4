...
class LogsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $logs = [
            ...
            ['p1 alpha1', 167.5, '2018-12-16', 'light', 1703, 2342],
            ['p1 alpha1', 167.4, '2018-12-17', 'light', 1703, 2044],
            ['p1 alpha1', 167.6, '2018-12-18', 'moderate', 1702, 2638],
            ['p1 alpha1', 167.6, '2018-12-19', 'low', 1702, 2042],
            ['p1 alpha1', 167.0, '2018-12-20', 'low', 1701, 2041],
            ['p1 alpha1', 167.1, '2018-12-21', 'low', 1701, 2041],
            ['p1 alpha1', 166.8, '2018-12-22', 'low', 1700, 2040],
            ['p1 alpha1', 166.8, '2018-12-23', 'low', 1700, 2040],
            ['p1 alpha1', 167.0, '2018-12-24', 'low', 1701, 2041],
            ['p1 alpha1', 167.0, '2018-12-25', 'low', 1701, 2041],
            ...
            ['p2 alpha2', 156.8, '2018-12-16', 'low', 1584, 1901],
            ['p2 alpha2', 156.8, '2018-12-17', 'light', 1584, 2178],
            ['p2 alpha2', 156.8, '2018-12-19', 'low', 1584, 1901],
            ['p2 alpha2', 156.8, '2018-12-20', 'moderate', 1584, 2455],
            ['p2 alpha2', 156.1, '2018-12-21', 'low', 1581, 1897],
            ['p2 alpha2', 156.1, '2018-12-23', 'moderate', 1584, 2451],
            ['p2 alpha2', 156.1, '2018-12-24', 'light', 1584, 2174],
            ['p2 alpha2', 156.1, '2018-12-26', 'high', 1584, 2727],
